...
Perplexity and Self-BLEU, while commonly used metrics, are not sufficient to evaluate creative text generation comprehensively.

Perplexity measures how well a model predicts the data but does not capture semantic relevance or diversity of generated outputs. A low perplexity might indicate fluent text but doesn't guarantee meaningful or contextually appropriate responses.

Self-BLEU evaluates diversity by comparing generated outputs to each other but fails to assess the relevance or coherence of the text. It can penalize models that generate similar yet highly relevant and meaningful responses.
...
![Average Score](./images/average_story_score_reasoning.png)
![Story Score Distribution](./images/story_score_distribution_reasoning.png)
...
```
"**Character Development**: 
   - The main character is John, a nervous and anxious individual who struggles with self-confidence.
     - Branch 1: John has a stutter that becomes more pronounced when he is nervous, which makes job interviews particularly daunting.
     - Branch 2: John is highly qualified for the position but has a history of being passed over for promotions and opportunities due to his lack of assertiveness.
     - Branch 3: John has a fear of public speaking, and the thought of presenting himself in an interview fills him with dread.

**Setting**:
   - The story takes place in a busy city, and the interview is for a competitive position at a prestigious company.
     - Branch 1: The interview is held in a modern, glass-walled office building, with the cityscape visible through the windows.
     - Branch 2: Alternatively, the interview could take place in a more intimate setting, a cozy but slightly claustrophobic meeting room.
     - Branch 3: The interview is conducted via video call, with technical difficulties adding to John's anxiety.

**Conflict/Problem**:
   - John's anxiety peaks during the job interview, and he struggles to present himself in a positive light.
     - Branch 1: John's nervousness causes him to stumble over his words, and he feels that he is unable to properly convey his qualifications and experience.
     - Branch 2: The interviewer is intimidating and seems uninterested, making John even more self-conscious and unsure of himself.
     - Branch 3: John freezes and is unable to answer a question, leading to an awkward silence that feels like an eternity.

**Resolution/Action**:
   - Despite the challenges, John manages to turn the interview around and showcase his potential.
     - Branch 1: John takes a moment to collect himself, apologizes for his nerves, and then confidently highlights his relevant skills and passion for the role.
     - Branch 2: John decides to be honest about his anxiety and explains how he has strategies to manage it, demonstrating self-awareness and a proactive approach.
     - Branch 3: With encouragement from the interviewer, John slowly builds confidence and is able to articulate his thoughts more clearly, showcasing his knowledge.

**Conclusion**:
   - The story ends with a sense of hope and the possibility of a positive outcome.
     - Branch 1: John leaves the interview feeling proud of how he handled the situation, regardless of whether he gets the job or not. He gains a new sense of self-belief.
     - Branch 2: The interviewer recognizes John's potential and offers him the position, seeing past his nervous exterior to the talented individual beneath.
     - Branch 3: While John doesn't get the job, he gains valuable experience and learns that his anxiety doesn't have to hold him back. He becomes more determined to overcome his fears."
```
**Strategy2:**
```
"**Character Development**: 
...
From our experiments, we get the following results which can be seen under the `/notebook/analysis_hypothesis.ipynb`: 

![Average Scores](./images/Average_scores_strategy.png)

![Latencies](./images/latencies_strategy.png)

![Story Score Distribution](./images/story_score_distribution_strategy.png)
...
![Combined Metrics Scenario1](./images/combined_50-50.png)
![Combined Metrics Scenario2](./images/combined_70-30.png)
![Combined Metrics Scenario3](./images/combined_80-20.png)
...
![Latencies by Reasoning](./images/latencies_reasoning.png)
